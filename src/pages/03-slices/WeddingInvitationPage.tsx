...
export const WeddingInvitationPage = () => {
  ...
  // const setEventYYYYMMDD = useWeddingBoundStore(state => state.setEventYYYYMMDD());
  // const setEventHHMM = useWeddingBoundStore(state => state.setEventHHMM());

  const setConfirmation = useWeddingBoundStore(state => state.setConfirm);
